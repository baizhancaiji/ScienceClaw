<template>
  <div class="flex flex-col items-center justify-center gap-6 flex-1 w-full min-h-0 bg-white">
    ...
    <div class="text-sm text-center text-[var(--text-tertiary)]">
      {{ t('Preview not available for this file type') }}<br>
      {{ t('Please download to view') }}
    </div>
