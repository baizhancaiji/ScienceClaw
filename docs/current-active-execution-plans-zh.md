...
- 下一批最小增量：4.1 Tools 页新增 MCP tab；只触碰 `ScienceClaw/frontend/src/pages/ToolsPage.vue` 与 `ScienceClaw/frontend/src/components/tools/McpToolsTab.vue`，接入 MCP tab、聚合工具列表和搜索。
- 建议验证：
